    ...
    <div className="timeline__container">
      <div className="timeline__box">
        ...
        <div className="p">
          ...
          <p>
            Becuase believe or not, each one of us in this room is one day going to stop breathing, turn cold and die. Id like you to step forward of you and peruse some of the faces from the past. Theyre not that different from you , are they? Same haircuts.
